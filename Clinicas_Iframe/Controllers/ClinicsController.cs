...
using Clinicas_Iframe.Data;
using Clinicas_Iframe.Models;

namespace Clinicas_Iframe.Controllers
{
    public class ClinicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,SiteAdress")] Clinics clinics)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,SiteAdress")] Clinics clinics)
        {
            if (id != clinics.Id)
            {
                return NotFound();
